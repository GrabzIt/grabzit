...
{if(options==null)
{options={}}
options.address=window.location.href;var div=document.createElement('div');div.appendChild(document.documentElement.cloneNode(!0));var inputs=div.getElementsByTagName('input');if(inputs!=null)
