...
namespace GrabzIt.Scraper.Enums
{
    public enum ErrorCode
    {
        ...
        ParameterMissingScrapeID = 158,
        ParameterInvalidScrapeID = 159,
        ParameterMissingScrapeStatus = 160,
        ParameterInvalidScrapeStatus = 161,
        ParameterInvalidScrapeStatusChange = 162,
