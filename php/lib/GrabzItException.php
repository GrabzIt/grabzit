...
class GrabzItException extends \Exception {
	...
	const PARAMETER_DURATION_TOO_LARGE = 181;
    const PARAMETER_START_TOO_LARGE = 182;
    const PARAMETER_INVALID_SCROLL_VALUE = 183;
    const PARAMETER_INVALID_HOVER_VALUE = 184;
