...
class GrabzItImageOptions(GrabzItBaseOptions.GrabzItBaseOptions):
        ...
        def _getSignatureString(self, applicationSecret, callBackURL, url = ''):
                ...
                "|"+str(self.format)+"|"+str(int(self.height))+"|"+str(int(self.width))+"|"+str(int(self.browserHeight))+ \
                "|"+str(int(self.browserWidth))+"|"+str(self.customId)+"|"+str(int(self.delay))+"|"+str(self.targetElement)+ \
